...
var scrambler = function (size, length, mult) {
  var randomSource;
...
module.exports['444'] = scrambler(4, 40, true);
module.exports['555'] = scrambler(5, 60, true);
module.exports['666'] = scrambler(6, 70, true);
module.exports['777'] = scrambler(7, 100, true);
